---
title: 在Customer Journey Analytics和Adobe Advertising之間交換資料的設定工作
description: 逐步說明在Customer Journey Analytics和Adobe Advertising之間交換資料所需的關鍵步驟
...
完成這些步驟並將資料檢視提供給您的Adobe客戶團隊後，您就可以完成其他步驟以設定整合。
...
### 步驟2：在Analysis Workspace中使用要匯出的量度建立資料檢視
...
### 步驟1：在Customer Journey Analytics中設定連線

>[!VIDEO](https://video.tv.adobe.com/v/3476860)

### 步驟2：在Customer Journey Analytics中設定資料檢視
